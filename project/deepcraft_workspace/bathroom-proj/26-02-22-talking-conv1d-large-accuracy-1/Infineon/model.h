...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x4c, 0x22, 0x58, 0x19, 0xae, 0xdc, 0xdc, 0x42, 0xb4, 0x10, 0xd1, 0xa6, 0x41, 0x4e, 0xf9, 0x21}
...
#define IMAI_DATA_OUT_SYMBOLS {"{unlabeled}", "brushing_teeth", "hair_drying", "showering"}
