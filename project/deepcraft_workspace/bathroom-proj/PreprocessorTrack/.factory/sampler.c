...
* 
* Generated at 02/19/2026 17:55:51 UTC. Any changes will be lost.
* 
* Memory    Size                      Efficiency
* Buffers   6160 bytes (RAM)          100 %
* State     12968 bytes (RAM)         100 %
...
#define _K10             ((float *)(_state + 0x00002ea0))    // f32[258] (1032 bytes) 
#define _K19             ((int8_t *)(_state + 0x000018d0))   // s8[5488] (5488 bytes) 
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[6352] (6352 bytes) 
#define _K9              ((int *)(_state + 0x00002e40))      // s32[24] (96 bytes) 
...
#define _K16             ((float *)(_buffer + 0x00000050))   // f32[20] (80 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    while(1) {
        __RETURN_ERROR_BREAK_EMPTY(fixwin_dequeuef32(_K5, _K3, 160, _K4));
        ...
        loge_f32(_K15, 20, _K16);
        __RETURN_ERROR_BREAK_EMPTY(fixwin_enqueuef32(_K19, _K16, _K4, 2));
    }
    __RETURN_ERROR(fixwin_dequeuef32(_K19, data_out, 33, time_out));
    return 0;
}
