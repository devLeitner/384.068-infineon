...
// Working memory
static int8_t _buffer[12296];
static int8_t _state[14688];
...
#define _K8              ((float *)_K8)                      // f32[1024] (4096 bytes) 
#define _K11             ((int *)(_state + 0x000030d0))      // s32[34] (136 bytes) 
#define _K12             ((float *)(_state + 0x00003158))    // f32[514] (2056 bytes) 
#define _K7              ((int8_t *)(_state + 0x00000000))   // s8[12496] (12496 bytes) 
#define _K10             ((float *)(_buffer + 0x00002000))   // f32[513,2] (4104 bytes) 
#define _K13             ((float *)(_buffer + 0x00000000))   // f32[1024] (4096 bytes) 
#define _K14             ((float *)(_buffer + 0x00000000))   // f32[513] (2052 bytes) 
#define _K16             ((float *)(_buffer + 0x00000804))   // f32[50] (200 bytes) 
#define _K17             ((float *)(_buffer + 0x00000000))   // f32[50] (200 bytes) 
#define _K18             ((float *)(_buffer + 0x000000c8))   // f32[50] (200 bytes) 
#define _K5              ((float *)(_buffer + 0x00000000))   // f32[1024] (4096 bytes) 
#define _K9              ((float *)(_buffer + 0x00001000))   // f32[1024] (4096 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    ...
    hammingmul_f32(_K5, _K8, _K9, 1024, 1);
    rdft_ndim_f32(_K9, _K10, 1, 1024, 1, _K11, _K12, _K13);
    norm_f32(_K10, 1, 2, 513, _K14);
    mel_f32(_K14, _K15, 513, 1, 50, _K16);
